...
def compare_selection():
    ...
    length = 5
    test_operators = [
        TestOperatorWrapper("Tournament 3",
                            TournamentSelection(tournament_size=3, higher_is_better=True)),
        TestOperatorWrapper("Tournament 5",
                            TournamentSelection(tournament_size=5, higher_is_better=True)),
        TestOperatorWrapper("Elitism 1",
                            ElitismSelection(num_elites=1, higher_is_better=True)),
        TestOperatorWrapper("Elitism 3",
                            ElitismSelection(num_elites=3, higher_is_better=True)),
        TestOperatorWrapper("Elitism 10",
                            ElitismSelection(num_elites=10, higher_is_better=True)),
        TestOperatorWrapper("Roulette  k-3",
                            RouletteSelection(higher_is_better=True, k=3)),
        TestOperatorWrapper("Roulette  k-5",
                            RouletteSelection(higher_is_better=True, k=5)),
        TestOperatorWrapper("Roulette  k-10",
                            RouletteSelection(higher_is_better=True, k=5)),
        TestOperatorWrapper("Stochastic k=3",
                            StochasticUniversalSelection(higher_is_better=True, k=3)),
        TestOperatorWrapper("Stochastic k=5",
                            StochasticUniversalSelection(higher_is_better=True, k=5)),
    ...
    for test_class in test_operators:
        ...
        result = float_vector_one_max_selection_runner(repeats=repeats, threshold=threshold,
                                                       selection=selection, length=length)
